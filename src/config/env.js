...
const envSchema = Joi.object({
  ...
  // Hard cap to prevent runaway worker spawn (can be overridden via env)
  MAX_WORKERS_CAP: Joi.number().default(16),
  ...
  PROCESS_LIMIT: Joi.number().optional(),
  RESERVED_PROCESS_SLOTS: Joi.number().default(2),
